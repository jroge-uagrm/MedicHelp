...
//Saas routes
Route::get('/showSubscriptions','SaasController@showSubscriptions');
Route::post('/subscriptionSelected','SaasController@generateMoney');
Route::post('/pay','SaasController@pay');
Route::get('/approval','SaasController@approval');
Route::get('/cancelled','SaasController@cancelled');
